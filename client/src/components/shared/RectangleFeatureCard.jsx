...
const RectangleFeatureCard = ({ feature, setEditDetails, searchTerm }) => {
    ...
    const sendMinMaxToServer = async (min, max) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error('Failed to send Min and Max values');
            }
        } catch (error) {
            ...
            <Card className="w-[350px]">
                <CardHeader>
                    ...
                    <CardDescription className="pb-2 flex-between gap-x-8">
                        ...
                        {type === "Rectangle" && <Badge className="bg-secondary">Rectangle</Badge>}
                    </CardDescription>
                    {/* Feature text */}
                    <CardTitle >
                        {editing ?
...
export default RectangleFeatureCard;