...
import RectangleFeatureCard from '@/components/shared/RectangleFeatureCard';
                ...
                {searchResults.length === 0 ?
                    ...
                    searchResults.map((feature, index) => {
                        ...
                        return type === "Rectangle" ? (
                            <RectangleFeatureCard key={index} feature={feature} setEditDetails={setEditDetails} searchTerm={searchTerm} />
                        ) : (
